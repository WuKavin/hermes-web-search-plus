...
class ExtractPlusCoreTests(unittest.TestCase):
    ...
    def test_extract_provider_priority_prefers_fast_clean_extractors(self):
        self.assertEqual(search.EXTRACT_PROVIDER_PRIORITY, ["tavily", "exa", "linkup", "parallel", "firecrawl", "you", "keenable", "serper", "anysearch", "donsetch"])
    ...
    def test_extract_priority_partial_invalid_values_are_ignored_and_filled(self):
        ...
        self.assertEqual(
            ...
            ["serper", "tavily", "exa", "linkup", "parallel", "firecrawl", "you", "keenable", "anysearch", "donsetch"],
        )
    ...
    def test_extract_priority_ignores_search_only_providers(self):
        ...
        self.assertEqual(
            search.resolve_extract_provider_priority(config),
            ["serper", "parallel", "tavily", "exa", "linkup", "firecrawl", "you", "keenable", "anysearch", "donsetch"],
        )
