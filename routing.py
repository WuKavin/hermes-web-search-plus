...
LANGUAGE_HINT_PROVIDER_BOOSTS: Dict[str, List[Tuple[str, float]]] = {
    "zh": [("anysearch", 10.0), ("exa", 7.0), ("you", 6.0), ("firecrawl", 4.0), ("linkup", 3.0), ("serper", 2.5)],
...
ROUTING_CLASS_PROVIDER_BOOSTS: Dict[str, List[Tuple[str, float]]] = {
    ...
    "official_regulatory": [("anysearch", 9.0), ("exa", 8.0), ("firecrawl", 6.0), ("serper", 5.0), ("you", 3.0)],
    ...
    "academic_arxiv": [("exa", 12.0), ("anysearch", 10.0), ("serper", 3.0), ("linkup", 2.0), ("you", 1.5)],
    "oss_discovery": [("exa", 8.0), ("firecrawl", 5.0), ("tavily", 4.0), ("you", 3.0)],
    "reddit_community": [("serper", 10.0), ("firecrawl", 8.0), ("tavily", 6.0), ("exa", -20.0)],
    "security_advisory": [("serper", 10.0), ("anysearch", 8.0), ("exa", 8.0), ("linkup", 5.0), ("you", 2.0), ("firecrawl", -20.0)],
    "finance_earnings_official": [("linkup", 14.0), ("anysearch", 9.0), ("you", 9.0), ("exa", 7.0), ("serper", 6.0), ("firecrawl", 4.0)],
    "finance_investor_monthly": [("linkup", 12.0), ("anysearch", 8.0), ("serper", 7.0), ("you", 5.0), ("exa", 4.0)],
    ...
    "patents": [("anysearch", 9.0), ("exa", 10.0), ("serper", 7.0), ("linkup", 4.0), ("you", 3.0)],
...
class QueryAnalyzer:
    ...
    ANYSEARCH_SIGNALS = {
        r'\bdoi\s*:?[ ]?10\.\d{4,9}/\S+': 5.0,
        r'\b(cve-\d{4}-\d+|vulnerability|security advisory|zero[- ]day)\b': 4.0,
        r'\b(patent|patentscope|espacenet|uspto)\b': 5.0,
        r'\b(earnings|revenue|investor relations|10-[qk]|financial report)\b': 4.0,
        r'\b(arxiv|academic paper|research paper|journal article|systematic review)\b': 4.0,
        r'\b(regulation|regulatory|legal analysis|case law|statute)\b': 4.0,
        r'\b(github|repository|source code|api reference)\b': 3.0,
        r'[\u4e00-\u9fff]': 2.0,
    }
    ...
    def analyze(self, query: str) -> Dict[str, Any]:
        ...
        anysearch_score, anysearch_matches = self._calculate_signal_score(
            query, self.ANYSEARCH_SIGNALS
        )
    ...
    def route(self, query: str) -> Dict[str, Any]:
        ...
        if not available:
            ...
            fallback = self.auto_config.get("fallback_provider", "anysearch")
            return {
                "provider": fallback,
                "confidence": 0.0,
        ...
        if analysis["routing_signal_score"] > 0 and self.auto_config.get("adaptive_routing", True):
